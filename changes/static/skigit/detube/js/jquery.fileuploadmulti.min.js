(function (b) {
    ...
    b.fn.uploadFile = function (t) {
        var r = b.extend({
            ...
            extErrorStr: "We're sorry...your file attachment failed to load due to incorrect file format. And the valid file formats are ",
            sizeErrorStr: "We're sorry...your file attachment failed to load because it exceeds the file size limit ",
        ...
        this.formGroup = d;
        this.hide();
        this.errorLog = b("<div class='edit_error_log'></div>");
		/*this.clearLog = b("<div class='clear'></div>");*/ 
        this.after(this.errorLog);
		this.after(this.clearLog);
        this.responses = [];
        if (!a.formdata) {
            r.dragDrop = false
        }
        ...
        function f(w, u, v) {
            ...
            v.on("drop", function (x) {
                ...
                if (!u.multiple && s.length > 1) {
                    if (u.showError) {
			if(document.getElementById("avatarstatus"))
				document.getElementById("avatarstatus").value="error";
			if(document.getElementById("statuscmp"))
				document.getElementById("statuscmp").value="error";
        ...
        function l(H, B, u) {
			...
			b("<div style='color:red;'>" + H.extErrorStr + H.allowedTypes + "</div>").appendTo(B.errorLog)	
                    }
                    continue
                }
			...
			if(document.getElementById("statuscmp"))
				document.getElementById("statuscmp").value="error";
                        b("<div style='color:red;'>" + H.sizeErrorStr + i(H.maxFileSize) + "</div>").appendTo(B.errorLog)
                    }
                    continue
                }
        ...
        function p(v, u) {
	        ...
	        this.deleteDiv = b("<span class='upload-delete'><img src='http://demo.mrphpguru.com/skigitdev/wp-content/themes/detube/images/skigitt_drop_close.png'></span>").appendTo(this.statusbar).hide();
